...
<section id="hero_section" className="inner hero-section commonpage" 
      style={{
      backgroundImage: advertiseMeta?.advertise_background
      ? `url(${advertiseMeta.advertise_background})`
      : "",
...
<div id="featurs_section" className="py-9 md:py-5 blogpgeMain"><h1 className="text:sm sm:text-lg md:text-2xl lg:text-3xl xl:text-[2.50rem] -tracking-tight md:leading-10 lg:leading-[3.5rem] font-semibold    font-lato lg:px-10" >{advertiseMeta?.advertise_title}</h1>
