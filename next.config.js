...
const nextConfig = {
   ...
   */
  env: {
    BASE_API_URL: "http://dev.vendorguideonline.com/api/",
    BASE_LARAVEL_URL: "http://dev.vendorguideonline.com/",
    NEXT_PUBLIC_API_URL: "http://dev.vendorguideonline.com/api/",
    ...
    return [
      {
        source: "/api/:path*",
        destination:
          "http://dev.vendorguideonline.com/api/:path*",
      },
    ];
  },
